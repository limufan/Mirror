...
namespace Mirror
{
    ...
    public sealed class InheritanceProxyTypeBuilderTests : AbstractProxyTypeBuilderTests
    {
        ...
        public void ImplementFinalMethodThatImplementsInterface()
        {
            ...
            MethodInfo method = ReflectionUtils.GetMethod(proxy, "Mirror.ITargetObjectTest.InterfaceMethodWithArguments", new Type[] { typeof(string) });
        ...
        public void DoesNotProxyNonProxiableInterface()
        {
            ...
            Assert.IsNotNull(foo.GetType().GetMethod("Mirror.IApplicationInterface.ApplicationMethod", BindingFlags.Instance | BindingFlags.NonPublic));

            // proxy implements IFrameworkInterface but should not proxy methods
            Assert.IsNull(foo.GetType().GetMethod("Mirror.IFrameworkInterface.FrameworkMethod", BindingFlags.Instance | BindingFlags.NonPublic));
        }
        ...
        public void ForcesNonProxiableInterfacesToBeProxied()
        {
            ...
            Assert.IsNotNull(foo.GetType().GetMethod("Mirror.IFrameworkInterface.FrameworkMethod", BindingFlags.Instance | BindingFlags.NonPublic));

            // proxy implements IApplicationInterface but should not proxy methods
            Assert.IsNull(foo.GetType().GetMethod("Mirror.IApplicationInterface.ApplicationMethod", BindingFlags.Instance | BindingFlags.NonPublic));
        }
