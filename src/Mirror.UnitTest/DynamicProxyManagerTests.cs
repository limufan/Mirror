...
namespace Mirror
{
    ...
    public class DynamicProxyManagerTests
    {
        ...
        public void CreateTypeBuilderMustNotBeCalledTwiceWithSameArguments()
        {
            ...
            try
            {
                TypeBuilder tb2 = DynamicProxyManager.CreateTypeBuilder("testtypename", typeof(ProxyTypeBuilder));
        ...
        private static void CallCreateTypeBuilder(object arg)
        {
            ...
            for(int i=0;i<100;i++)
            {
                DynamicProxyManager.CreateTypeBuilder( "TestType" + nr + "_" + i,typeof( ProxyTypeBuilder ) );
                Thread.Sleep(0);
            }
        }
    }
