...
namespace Mirror.Util
{
    ...
    /// </remarks>
    /// <example>
    /// <p>The following excerpt from <see cref="Mirror.DynamicProxyManager"/> demonstrates usage:</p>
    /// <code language="c#">
    /// public class DynamicProxyManager
    /// {
    ///   public const string PROXY_ASSEMBLY_NAME = "Mirror";
    ///
    ...
    /// <seealso cref="Mirror.DynamicProxyManager"/>
    /// <seealso cref="Spring.Objects.Factory.Support.MethodInjectingInstantiationStrategy"/>
    public sealed class DynamicCodeManager
    {
        private static readonly Hashtable s_moduleCache = new Hashtable(); //CollectionsUtil.CreateCaseInsensitiveHashtable();
